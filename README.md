...
A threshold of 0.5 is used to convert probabilities into class predictions.
...
However, due to the small dataset, the model is likely overfitting and may not generalize well to unseen data.
